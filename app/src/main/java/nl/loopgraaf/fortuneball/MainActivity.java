package nl.loopgraaf.fortuneball;
...
public class MainActivity extends AppCompatActivity {
    String fortuneList[] = {"Ik zou er niet op rekenen","Nu zijn de sterren niet duidelijk, vraag het later nog eens","Je mag er vanuit gaan","Zonder twijfel","het ziet er slecht uit","Het is zo","De planeten zeggen Ja","Ja Absoluut","Ja","De planeten zeggen Nee"};
